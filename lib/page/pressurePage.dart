...
class _PressurePageState extends State<PressurePage> {
  ...
  List<String> generateRealTimeUrls(Brightness brightness) {
    ...
    return [
      'https://rarief.com:3000/d-solo/f77661b1-54aa-4ae1-b3d6-fe60e777effe/data-erispro?orgId=1&from=now&to=now&theme=$theme&panelId=28',
      'https://rarief.com:3000/d-solo/f77661b1-54aa-4ae1-b3d6-fe60e777effe/data-erispro?orgId=1&from=now&to=now&theme=$theme&panelId=37',
    ];
  }
  ...
  List<String> generateAnalyticUrls(String range, Brightness brightness) {
    ...
    return [
      'https://rarief.com:3000/d-solo/f77661b1-54aa-4ae1-b3d6-fe60e777effe/data-erispro?orgId=1&from=$from&to=$now&theme=$theme&panelId=72',
      'https://rarief.com:3000/d-solo/f77661b1-54aa-4ae1-b3d6-fe60e777effe/data-erispro?orgId=1&from=$from&to=$now&theme=$theme&panelId=73',
    ];
  }
