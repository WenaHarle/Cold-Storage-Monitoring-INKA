...
class _O2PageState extends State<O2Page> {
  ...
  List<String> generateUrls(String range) {
    ...
    switch (range) {
      case '10 minutes':
        return [
          'http://175.45.186.55:3000/d-solo/e001a7c7-1de1-4977-999c-30ec8a391284/data-sensor-detail?orgId=1&from=1720878240768&to=1721569440768&panelId=6',
          'http://175.45.186.55:3000/d-solo/e001a7c7-1de1-4977-999c-30ec8a391284/data-sensor-detail?orgId=1&from=1720878240768&to=1721569440768&panelId=55',
          'http://175.45.186.55:3000/d-solo/e001a7c7-1de1-4977-999c-30ec8a391284/data-sensor-detail?orgId=1&from=1720878240768&to=1721569440768&panelId=56'
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: WebView(
                  initialUrl: 'http://175.45.186.55:3000/d-solo/e001a7c7-1de1-4977-999c-30ec8a391284/data-sensor-detail?orgId=1&from=1720878240768&to=1721569440768&panelId=29', // Example URL for additional WebView
                ...
                children: [
                  Expanded(
                    child: Container(
                      height: 200, // Set desired height
                      child: WebView(
                        initialUrl: 'http://175.45.186.55:3000/d-solo/e001a7c7-1de1-4977-999c-30ec8a391284/data-sensor-detail?orgId=1&from=1720878240768&to=1721569440768&panelId=65',
                        javascriptMode: JavascriptMode.unrestricted,
                        backgroundColor: Colors.transparent, // Make WebView background transparent
                      ),
                    ),
                  ...
                  Expanded(
                    child: Container(
                      height: 200, // Set desired height
                      child: WebView(
                        initialUrl: 'http://175.45.186.55:3000/d-solo/e001a7c7-1de1-4977-999c-30ec8a391284/data-sensor-detail?orgId=1&from=1720878240768&to=1721569440768&panelId=66', // Example URL for additional WebView
                        javascriptMode: JavascriptMode.unrestricted,
                        backgroundColor: Colors.transparent, // Make WebView background transparent
                      ),
                    ),
